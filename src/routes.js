...
const routes = [
  ...
  {path: "/Partners", name: "Partners", component: ViewPartners },
  {path: "/view-partner-member/:id", exact: true, name: "View Partner Member", component: PartnersMember },
  {path: "/transactions", name: "Transactions", component: Transactions},
  {path: "/tables/assignPartners", name: "Assign Customers With Partners", component: AssignPartners},
  {path: "/role", name: "Roles Table", component: ViewRole },
  {path: "/team-has-role", name: "Team Has Role", component: TeamHasRole },
  {path: "/souls-settings", name: "Souls Settings", component: SoulsSettings},
  {path: "/CommunicationTempelate", name: "Communication Tempelate", component: ViewCommunicationTempelate},
  {path: "/view-communication-tempelate/:id", exact: true, name: "View Communication Tempelate", component: CommTempelateMember},
  {path: "/add-communication-tempelate", exact: true,name: "Create Communication Tempelate",component: CommunicationTempelate},
  {path: "/edit-communication-tempelate/:id",exact: true,name: "Update Communication Tempelate",component: CommunicationTempelate},
  // { path: '/base', exact: true, name: 'Base', component: Cards },
  // { path: '/base/cards', name: 'Cards', component: Cards },
  {path: "/add-partner",exact: true,name: "Add Partner",component: Partner},
  {path: "/edit-partner/:id",exact: true,name: "Edit Partner",component: PartnerEdit},
