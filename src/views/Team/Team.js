...
class Team extends Component {
    ...
    validate =()=>{
      ...
      if(!this.state.first_name){
        first_nameError = "can't be empty";
      }
      ...
      if(first_nameError || last_nameError || passwordError || mobileError || emailError || joiningError || addressError || roleError || statusError || genderError){
        this.setState({first_nameError, last_nameError, passwordError, mobileError, emailError, joiningError, addressError, genderError, statusError, roleError});
        return false;
      }
      return true;
    };
