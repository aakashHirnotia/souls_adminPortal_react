      ...
      <div className="animated fadeIn">
        <div className="card">
          <div className="card-header">
            <i className="glyphicon glyphicon-user"></i> Theme colors
          </div>
        ...
        <div className="card">
          <div className="card-header">
            <i className="glyphicon glyphicon-user"></i> Grays
          </div>
          <div className="card-body">
            <Row className="mb-3">
        ...
        <div className="card">
          <div className="card-header">
            <i className="glyphicon glyphicon-user"></i> Additional colors
          </div>
          <div className="card-body">
            <Row>
